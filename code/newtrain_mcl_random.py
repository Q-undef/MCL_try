...
from dataloaders.dataset import (BaseDataSet, RandomGenerator)
...
parser.add_argument('--root_path', type=str,
                    default='../data/MLT', help='Name of Experiment')
parser.add_argument('--dataset', type=str,
                    default='ACDC', help='experiment_name')
parser.add_argument('--list_dir', type=str,
                    default='/data/dataset/Lung_semi/lists/lists_MLT', help='list dir')
parser.add_argument('--exp', type=str,
                    default='ACDC/mask', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        ...
        for i, unlabeled_batch in enumerate(trainloader_unlabeled):
            ...
            logging.info('iteration %d : loss : %f ; loss_supervised : %f ;' % (iter_num, total_loss.item(), supervised_loss.item()))
