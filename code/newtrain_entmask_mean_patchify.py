...
from utils.mask import random_mask, ent_mask_patch_countnum, ent_mask_patch_mean
...
parser.add_argument('--exp', type=str,
                    default='ACDC/new_entmask_patchMean_test_0.5_hint0.05', help='experiment_name')
...
parser.add_argument('--hint', type=int, default=1,
                    help='if or not to maintain the highest parts of entropy value when counting mean-patchify-mask')                
    ...
    for epoch_num in iterator:
        ...
        for i, unlabeled_batch in enumerate(trainloader_unlabeled):
            ...
            if epoch_num >= max_epochs * args.start_consistency_epoch:
                ...
                mask_unlabeled_image_batch, mask = ent_mask_patch_mean(unlabeled_image_batch, EMap, args.mask_ratio, 16, 256, hint)
